...
class ImageMultilabelDataParameter;
...
class NeuralDecisionForestParameter;
class LDLMetricParameter;
class CSParameter;
...
enum LDLMetricParameter_LDLMetricType {
  LDLMetricParameter_LDLMetricType_KLD = 1,
  LDLMetricParameter_LDLMetricType_Clark = 2,
  LDLMetricParameter_LDLMetricType_Chebyshev = 3,
  LDLMetricParameter_LDLMetricType_Canberra = 4,
  LDLMetricParameter_LDLMetricType_Cosine = 5,
  LDLMetricParameter_LDLMetricType_Inter = 6,
  LDLMetricParameter_LDLMetricType_Fidelity = 7,
  LDLMetricParameter_LDLMetricType_Euclid = 8,
  LDLMetricParameter_LDLMetricType_Soren = 9,
  LDLMetricParameter_LDLMetricType_Square = 10
};
bool LDLMetricParameter_LDLMetricType_IsValid(int value);
const LDLMetricParameter_LDLMetricType LDLMetricParameter_LDLMetricType_LDLMetricType_MIN = LDLMetricParameter_LDLMetricType_KLD;
const LDLMetricParameter_LDLMetricType LDLMetricParameter_LDLMetricType_LDLMetricType_MAX = LDLMetricParameter_LDLMetricType_Square;
const int LDLMetricParameter_LDLMetricType_LDLMetricType_ARRAYSIZE = LDLMetricParameter_LDLMetricType_LDLMetricType_MAX + 1;

const ::google::protobuf::EnumDescriptor* LDLMetricParameter_LDLMetricType_descriptor();
inline const ::std::string& LDLMetricParameter_LDLMetricType_Name(LDLMetricParameter_LDLMetricType value) {
  return ::google::protobuf::internal::NameOfEnum(
    LDLMetricParameter_LDLMetricType_descriptor(), value);
}
inline bool LDLMetricParameter_LDLMetricType_Parse(
    const ::std::string& name, LDLMetricParameter_LDLMetricType* value) {
  return ::google::protobuf::internal::ParseNamedEnum<LDLMetricParameter_LDLMetricType>(
    LDLMetricParameter_LDLMetricType_descriptor(), name, value);
}
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.ImageMultilabelDataParameter image_multilabel_data_param = 147;
  inline bool has_image_multilabel_data_param() const;
  inline void clear_image_multilabel_data_param();
  static const int kImageMultilabelDataParamFieldNumber = 147;
  inline const ::caffe::ImageMultilabelDataParameter& image_multilabel_data_param() const;
  inline ::caffe::ImageMultilabelDataParameter* mutable_image_multilabel_data_param();
  inline ::caffe::ImageMultilabelDataParameter* release_image_multilabel_data_param();
  inline void set_allocated_image_multilabel_data_param(::caffe::ImageMultilabelDataParameter* image_multilabel_data_param);
  ...
  // optional .caffe.NeuralDecisionForestParameter neural_decision_forest_param = 148;
  inline bool has_neural_decision_forest_param() const;
  inline void clear_neural_decision_forest_param();
  static const int kNeuralDecisionForestParamFieldNumber = 148;
  inline const ::caffe::NeuralDecisionForestParameter& neural_decision_forest_param() const;
  inline ::caffe::NeuralDecisionForestParameter* mutable_neural_decision_forest_param();
  inline ::caffe::NeuralDecisionForestParameter* release_neural_decision_forest_param();
  inline void set_allocated_neural_decision_forest_param(::caffe::NeuralDecisionForestParameter* neural_decision_forest_param);

  // optional .caffe.LDLMetricParameter ldl_metric_param = 149;
  inline bool has_ldl_metric_param() const;
  inline void clear_ldl_metric_param();
  static const int kLdlMetricParamFieldNumber = 149;
  inline const ::caffe::LDLMetricParameter& ldl_metric_param() const;
  inline ::caffe::LDLMetricParameter* mutable_ldl_metric_param();
  inline ::caffe::LDLMetricParameter* release_ldl_metric_param();
  inline void set_allocated_ldl_metric_param(::caffe::LDLMetricParameter* ldl_metric_param);

  // optional .caffe.CSParameter cs_param = 150;
  inline bool has_cs_param() const;
  inline void clear_cs_param();
  static const int kCsParamFieldNumber = 150;
  inline const ::caffe::CSParameter& cs_param() const;
  inline ::caffe::CSParameter* mutable_cs_param();
  inline ::caffe::CSParameter* release_cs_param();
  inline void set_allocated_cs_param(::caffe::CSParameter* cs_param);
 ...
 private:
  ...
  inline void set_has_image_multilabel_data_param();
  inline void clear_has_image_multilabel_data_param();
  ...
  inline void set_has_neural_decision_forest_param();
  inline void clear_has_neural_decision_forest_param();
  inline void set_has_ldl_metric_param();
  inline void clear_has_ldl_metric_param();
  inline void set_has_cs_param();
  inline void clear_has_cs_param();
  ...
  ::caffe::ImageMultilabelDataParameter* image_multilabel_data_param_;
  ...
  ::caffe::NeuralDecisionForestParameter* neural_decision_forest_param_;
  ::caffe::LDLMetricParameter* ldl_metric_param_;
  ::caffe::CSParameter* cs_param_;
  int phase_;
  mutable int _cached_size_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
...
class ImageMultilabelDataParameter : public ::google::protobuf::Message {
 public:
  ImageMultilabelDataParameter();
  virtual ~ImageMultilabelDataParameter();

  ImageMultilabelDataParameter(const ImageMultilabelDataParameter& from);

  inline ImageMultilabelDataParameter& operator=(const ImageMultilabelDataParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const ImageMultilabelDataParameter& default_instance();

  void Swap(ImageMultilabelDataParameter* other);

  // implements Message ----------------------------------------------

  ImageMultilabelDataParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const ImageMultilabelDataParameter& from);
  void MergeFrom(const ImageMultilabelDataParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // @@protoc_insertion_point(class_scope:caffe.ImageMultilabelDataParameter)
 private:
  ...
  void InitAsDefaultInstance();
  static ImageMultilabelDataParameter* default_instance_;
};
// -------------------------------------------------------------------
...
class NeuralDecisionForestParameter : public ::google::protobuf::Message {
 public:
  NeuralDecisionForestParameter();
  virtual ~NeuralDecisionForestParameter();

  NeuralDecisionForestParameter(const NeuralDecisionForestParameter& from);

  inline NeuralDecisionForestParameter& operator=(const NeuralDecisionForestParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const NeuralDecisionForestParameter& default_instance();

  void Swap(NeuralDecisionForestParameter* other);

  // implements Message ----------------------------------------------

  NeuralDecisionForestParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const NeuralDecisionForestParameter& from);
  void MergeFrom(const NeuralDecisionForestParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  inline ::google::protobuf::uint32 num_trees() const;
  inline void set_num_trees(::google::protobuf::uint32 value);
  ...
  inline bool has_iter_times_class_label_distr() const;
  inline void clear_iter_times_class_label_distr();
  static const int kIterTimesClassLabelDistrFieldNumber = 4;
  inline ::google::protobuf::uint32 iter_times_class_label_distr() const;
  inline void set_iter_times_class_label_distr(::google::protobuf::uint32 value);

  // optional uint32 iter_times_in_epoch = 7 [default = 20];
  inline bool has_iter_times_in_epoch() const;
  inline void clear_iter_times_in_epoch();
  static const int kIterTimesInEpochFieldNumber = 7;
  inline ::google::protobuf::uint32 iter_times_in_epoch() const;
  inline void set_iter_times_in_epoch(::google::protobuf::uint32 value);

  // optional string record_filename = 5 [default = "Forest.Record"];
  inline bool has_record_filename() const;
  inline void clear_record_filename();
  static const int kRecordFilenameFieldNumber = 5;
  inline const ::std::string& record_filename() const;
  inline void set_record_filename(const ::std::string& value);
  inline void set_record_filename(const char* value);
  inline void set_record_filename(const char* value, size_t size);
  inline ::std::string* mutable_record_filename();
  inline ::std::string* release_record_filename();
  inline void set_allocated_record_filename(::std::string* record_filename);
  ...
  inline bool has_debug_gpu() const;
  inline void clear_debug_gpu();
  static const int kDebugGpuFieldNumber = 8;
  inline bool debug_gpu() const;
  inline void set_debug_gpu(bool value);

  // optional bool use_gpu = 9 [default = true];
  inline bool has_use_gpu() const;
  inline void clear_use_gpu();
  static const int kUseGpuFieldNumber = 9;
  inline bool use_gpu() const;
  inline void set_use_gpu(bool value);

  // optional uint32 all_data_vec_length = 10 [default = 5];
  inline bool has_all_data_vec_length() const;
  inline void clear_all_data_vec_length();
  static const int kAllDataVecLengthFieldNumber = 10;
  inline ::google::protobuf::uint32 all_data_vec_length() const;
  inline void set_all_data_vec_length(::google::protobuf::uint32 value);

  // optional bool drop_out = 11 [default = false];
  inline bool has_drop_out() const;
  inline void clear_drop_out();
  static const int kDropOutFieldNumber = 11;
  inline bool drop_out() const;
  inline void set_drop_out(bool value);

  // optional string init_filename = 12 [default = "Leafnode.Init"];
  inline bool has_init_filename() const;
  inline void clear_init_filename();
  static const int kInitFilenameFieldNumber = 12;
  inline const ::std::string& init_filename() const;
  inline void set_init_filename(const ::std::string& value);
  inline void set_init_filename(const char* value);
  inline void set_init_filename(const char* value, size_t size);
  inline ::std::string* mutable_init_filename();
  inline ::std::string* release_init_filename();
  inline void set_allocated_init_filename(::std::string* init_filename);

  // optional float scale = 13 [default = 100];
  inline bool has_scale() const;
  inline void clear_scale();
  static const int kScaleFieldNumber = 13;
  inline float scale() const;
  inline void set_scale(float value);
 ...
 private:
  ...
  inline void set_has_iter_times_class_label_distr();
  inline void clear_has_iter_times_class_label_distr();
  inline void set_has_iter_times_in_epoch();
  inline void clear_has_iter_times_in_epoch();
  inline void set_has_record_filename();
  inline void clear_has_record_filename();
  inline void set_has_axis();
  inline void clear_has_axis();
  inline void set_has_debug_gpu();
  inline void clear_has_debug_gpu();
  inline void set_has_use_gpu();
  inline void clear_has_use_gpu();
  inline void set_has_all_data_vec_length();
  inline void clear_has_all_data_vec_length();
  inline void set_has_drop_out();
  inline void clear_has_drop_out();
  inline void set_has_init_filename();
  inline void clear_has_init_filename();
  inline void set_has_scale();
  inline void clear_has_scale();
  ...
  ::google::protobuf::uint32 num_trees_;
  ::google::protobuf::uint32 num_classes_;
  ::google::protobuf::uint32 iter_times_class_label_distr_;
  static ::std::string* _default_record_filename_;
  ::std::string* record_filename_;
  ::google::protobuf::uint32 iter_times_in_epoch_;
  ::google::protobuf::uint32 axis_;
  bool debug_gpu_;
  bool use_gpu_;
  bool drop_out_;
  ::google::protobuf::uint32 all_data_vec_length_;
  static ::std::string* _default_init_filename_;
  ...
  void InitAsDefaultInstance();
  static NeuralDecisionForestParameter* default_instance_;
};
// -------------------------------------------------------------------

class LDLMetricParameter : public ::google::protobuf::Message {
 public:
  LDLMetricParameter();
  virtual ~LDLMetricParameter();

  LDLMetricParameter(const LDLMetricParameter& from);

  inline LDLMetricParameter& operator=(const LDLMetricParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const LDLMetricParameter& default_instance();

  void Swap(LDLMetricParameter* other);

  // implements Message ----------------------------------------------

  LDLMetricParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const LDLMetricParameter& from);
  void MergeFrom(const LDLMetricParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  typedef LDLMetricParameter_LDLMetricType LDLMetricType;
  static const LDLMetricType KLD = LDLMetricParameter_LDLMetricType_KLD;
  static const LDLMetricType Clark = LDLMetricParameter_LDLMetricType_Clark;
  static const LDLMetricType Chebyshev = LDLMetricParameter_LDLMetricType_Chebyshev;
  static const LDLMetricType Canberra = LDLMetricParameter_LDLMetricType_Canberra;
  static const LDLMetricType Cosine = LDLMetricParameter_LDLMetricType_Cosine;
  static const LDLMetricType Inter = LDLMetricParameter_LDLMetricType_Inter;
  static const LDLMetricType Fidelity = LDLMetricParameter_LDLMetricType_Fidelity;
  static const LDLMetricType Euclid = LDLMetricParameter_LDLMetricType_Euclid;
  static const LDLMetricType Soren = LDLMetricParameter_LDLMetricType_Soren;
  static const LDLMetricType Square = LDLMetricParameter_LDLMetricType_Square;
  static inline bool LDLMetricType_IsValid(int value) {
    return LDLMetricParameter_LDLMetricType_IsValid(value);
  }
  static const LDLMetricType LDLMetricType_MIN =
    LDLMetricParameter_LDLMetricType_LDLMetricType_MIN;
  static const LDLMetricType LDLMetricType_MAX =
    LDLMetricParameter_LDLMetricType_LDLMetricType_MAX;
  static const int LDLMetricType_ARRAYSIZE =
    LDLMetricParameter_LDLMetricType_LDLMetricType_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  LDLMetricType_descriptor() {
    return LDLMetricParameter_LDLMetricType_descriptor();
  }
  static inline const ::std::string& LDLMetricType_Name(LDLMetricType value) {
    return LDLMetricParameter_LDLMetricType_Name(value);
  }
  static inline bool LDLMetricType_Parse(const ::std::string& name,
      LDLMetricType* value) {
    return LDLMetricParameter_LDLMetricType_Parse(name, value);
  }

  // accessors -------------------------------------------------------

  // optional .caffe.LDLMetricParameter.LDLMetricType metric_type = 1 [default = KLD];
  inline bool has_metric_type() const;
  inline void clear_metric_type();
  static const int kMetricTypeFieldNumber = 1;
  inline ::caffe::LDLMetricParameter_LDLMetricType metric_type() const;
  inline void set_metric_type(::caffe::LDLMetricParameter_LDLMetricType value);

  // @@protoc_insertion_point(class_scope:caffe.LDLMetricParameter)
 private:
  inline void set_has_metric_type();
  ...
  void InitAsDefaultInstance();
  static LDLMetricParameter* default_instance_;
};
// -------------------------------------------------------------------

class CSParameter : public ::google::protobuf::Message {
 public:
  CSParameter();
  virtual ~CSParameter();

  CSParameter(const CSParameter& from);

  inline CSParameter& operator=(const CSParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const CSParameter& default_instance();

  void Swap(CSParameter* other);

  // implements Message ----------------------------------------------

  CSParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const CSParameter& from);
  void MergeFrom(const CSParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  inline bool has_lll() const;
  inline void clear_lll();
  static const int kLllFieldNumber = 1;
  inline ::google::protobuf::int32 lll() const;
  inline void set_lll(::google::protobuf::int32 value);

  // @@protoc_insertion_point(class_scope:caffe.CSParameter)
 private:
  inline void set_has_lll();
  inline void clear_has_lll();

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::google::protobuf::int32 lll_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();

  void InitAsDefaultInstance();
  static CSParameter* default_instance_;
};
// -------------------------------------------------------------------
...
class V1LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.ImageMultilabelDataParameter image_multilabel_data_param = 47;
  inline bool has_image_multilabel_data_param() const;
  inline void clear_image_multilabel_data_param();
  static const int kImageMultilabelDataParamFieldNumber = 47;
  inline const ::caffe::ImageMultilabelDataParameter& image_multilabel_data_param() const;
  inline ::caffe::ImageMultilabelDataParameter* mutable_image_multilabel_data_param();
  inline ::caffe::ImageMultilabelDataParameter* release_image_multilabel_data_param();
  inline void set_allocated_image_multilabel_data_param(::caffe::ImageMultilabelDataParameter* image_multilabel_data_param);
...
// optional .caffe.ImageMultilabelDataParameter image_multilabel_data_param = 147;
inline bool LayerParameter::has_image_multilabel_data_param() const {
  return (_has_bits_[1] & 0x00000200u) != 0;
}
inline void LayerParameter::set_has_image_multilabel_data_param() {
  _has_bits_[1] |= 0x00000200u;
}
inline void LayerParameter::clear_has_image_multilabel_data_param() {
  _has_bits_[1] &= ~0x00000200u;
}
inline void LayerParameter::clear_image_multilabel_data_param() {
  if (image_multilabel_data_param_ != NULL) image_multilabel_data_param_->::caffe::ImageMultilabelDataParameter::Clear();
  clear_has_image_multilabel_data_param();
}
inline const ::caffe::ImageMultilabelDataParameter& LayerParameter::image_multilabel_data_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.image_multilabel_data_param)
  return image_multilabel_data_param_ != NULL ? *image_multilabel_data_param_ : *default_instance_->image_multilabel_data_param_;
}
inline ::caffe::ImageMultilabelDataParameter* LayerParameter::mutable_image_multilabel_data_param() {
  set_has_image_multilabel_data_param();
  if (image_multilabel_data_param_ == NULL) image_multilabel_data_param_ = new ::caffe::ImageMultilabelDataParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.image_multilabel_data_param)
  return image_multilabel_data_param_;
}
inline ::caffe::ImageMultilabelDataParameter* LayerParameter::release_image_multilabel_data_param() {
  clear_has_image_multilabel_data_param();
  ::caffe::ImageMultilabelDataParameter* temp = image_multilabel_data_param_;
  image_multilabel_data_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_image_multilabel_data_param(::caffe::ImageMultilabelDataParameter* image_multilabel_data_param) {
  delete image_multilabel_data_param_;
  image_multilabel_data_param_ = image_multilabel_data_param;
  if (image_multilabel_data_param) {
    set_has_image_multilabel_data_param();
  } else {
    clear_has_image_multilabel_data_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.image_multilabel_data_param)
}
...
// optional .caffe.NeuralDecisionForestParameter neural_decision_forest_param = 148;
inline bool LayerParameter::has_neural_decision_forest_param() const {
  return (_has_bits_[1] & 0x08000000u) != 0;
}
inline void LayerParameter::set_has_neural_decision_forest_param() {
  _has_bits_[1] |= 0x08000000u;
}
inline void LayerParameter::clear_has_neural_decision_forest_param() {
  _has_bits_[1] &= ~0x08000000u;
}
inline void LayerParameter::clear_neural_decision_forest_param() {
  if (neural_decision_forest_param_ != NULL) neural_decision_forest_param_->::caffe::NeuralDecisionForestParameter::Clear();
  clear_has_neural_decision_forest_param();
}
inline const ::caffe::NeuralDecisionForestParameter& LayerParameter::neural_decision_forest_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.neural_decision_forest_param)
  return neural_decision_forest_param_ != NULL ? *neural_decision_forest_param_ : *default_instance_->neural_decision_forest_param_;
}
inline ::caffe::NeuralDecisionForestParameter* LayerParameter::mutable_neural_decision_forest_param() {
  set_has_neural_decision_forest_param();
  if (neural_decision_forest_param_ == NULL) neural_decision_forest_param_ = new ::caffe::NeuralDecisionForestParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.neural_decision_forest_param)
  return neural_decision_forest_param_;
}
inline ::caffe::NeuralDecisionForestParameter* LayerParameter::release_neural_decision_forest_param() {
  clear_has_neural_decision_forest_param();
  ::caffe::NeuralDecisionForestParameter* temp = neural_decision_forest_param_;
  neural_decision_forest_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_neural_decision_forest_param(::caffe::NeuralDecisionForestParameter* neural_decision_forest_param) {
  delete neural_decision_forest_param_;
  neural_decision_forest_param_ = neural_decision_forest_param;
  if (neural_decision_forest_param) {
    set_has_neural_decision_forest_param();
  } else {
    clear_has_neural_decision_forest_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.neural_decision_forest_param)
}

// optional .caffe.LDLMetricParameter ldl_metric_param = 149;
inline bool LayerParameter::has_ldl_metric_param() const {
  return (_has_bits_[1] & 0x10000000u) != 0;
}
inline void LayerParameter::set_has_ldl_metric_param() {
  _has_bits_[1] |= 0x10000000u;
}
inline void LayerParameter::clear_has_ldl_metric_param() {
  _has_bits_[1] &= ~0x10000000u;
}
inline void LayerParameter::clear_ldl_metric_param() {
  if (ldl_metric_param_ != NULL) ldl_metric_param_->::caffe::LDLMetricParameter::Clear();
  clear_has_ldl_metric_param();
}
inline const ::caffe::LDLMetricParameter& LayerParameter::ldl_metric_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.ldl_metric_param)
  return ldl_metric_param_ != NULL ? *ldl_metric_param_ : *default_instance_->ldl_metric_param_;
}
inline ::caffe::LDLMetricParameter* LayerParameter::mutable_ldl_metric_param() {
  set_has_ldl_metric_param();
  if (ldl_metric_param_ == NULL) ldl_metric_param_ = new ::caffe::LDLMetricParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.ldl_metric_param)
  return ldl_metric_param_;
}
inline ::caffe::LDLMetricParameter* LayerParameter::release_ldl_metric_param() {
  clear_has_ldl_metric_param();
  ::caffe::LDLMetricParameter* temp = ldl_metric_param_;
  ldl_metric_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_ldl_metric_param(::caffe::LDLMetricParameter* ldl_metric_param) {
  delete ldl_metric_param_;
  ldl_metric_param_ = ldl_metric_param;
  if (ldl_metric_param) {
    set_has_ldl_metric_param();
  } else {
    clear_has_ldl_metric_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.ldl_metric_param)
}

// optional .caffe.CSParameter cs_param = 150;
inline bool LayerParameter::has_cs_param() const {
  return (_has_bits_[1] & 0x20000000u) != 0;
}
inline void LayerParameter::set_has_cs_param() {
  _has_bits_[1] |= 0x20000000u;
}
inline void LayerParameter::clear_has_cs_param() {
  _has_bits_[1] &= ~0x20000000u;
}
inline void LayerParameter::clear_cs_param() {
  if (cs_param_ != NULL) cs_param_->::caffe::CSParameter::Clear();
  clear_has_cs_param();
}
inline const ::caffe::CSParameter& LayerParameter::cs_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.cs_param)
  return cs_param_ != NULL ? *cs_param_ : *default_instance_->cs_param_;
}
inline ::caffe::CSParameter* LayerParameter::mutable_cs_param() {
  set_has_cs_param();
  if (cs_param_ == NULL) cs_param_ = new ::caffe::CSParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.cs_param)
  return cs_param_;
}
inline ::caffe::CSParameter* LayerParameter::release_cs_param() {
  clear_has_cs_param();
  ::caffe::CSParameter* temp = cs_param_;
  cs_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_cs_param(::caffe::CSParameter* cs_param) {
  delete cs_param_;
  cs_param_ = cs_param;
  if (cs_param) {
    set_has_cs_param();
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.cs_param)
}
...
// optional string source = 1;
inline bool ImageMultilabelDataParameter::has_source() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void ImageMultilabelDataParameter::set_has_source() {
  _has_bits_[0] |= 0x00000001u;
}
inline void ImageMultilabelDataParameter::clear_has_source() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void ImageMultilabelDataParameter::clear_source() {
  if (source_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    source_->clear();
  }
  clear_has_source();
}
inline const ::std::string& ImageMultilabelDataParameter::source() const {
  // @@protoc_insertion_point(field_get:caffe.ImageMultilabelDataParameter.source)
  return *source_;
}
inline void ImageMultilabelDataParameter::set_source(const ::std::string& value) {
  set_has_source();
  if (source_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    source_ = new ::std::string;
  }
  source_->assign(value);
  // @@protoc_insertion_point(field_set:caffe.ImageMultilabelDataParameter.source)
}
inline void ImageMultilabelDataParameter::set_source(const char* value) {
  set_has_source();
  if (source_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    source_ = new ::std::string;
  }
  source_->assign(value);
  // @@protoc_insertion_point(field_set_char:caffe.ImageMultilabelDataParameter.source)
}
inline void ImageMultilabelDataParameter::set_source(const char* value, size_t size) {
  set_has_source();
  if (source_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    source_ = new ::std::string;
  }
  source_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:caffe.ImageMultilabelDataParameter.source)
}
inline ::std::string* ImageMultilabelDataParameter::mutable_source() {
  set_has_source();
  if (source_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    source_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:caffe.ImageMultilabelDataParameter.source)
  return source_;
}
inline ::std::string* ImageMultilabelDataParameter::release_source() {
  clear_has_source();
  if (source_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
...
inline void ImageMultilabelDataParameter::set_allocated_source(::std::string* source) {
  if (source_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete source_;
  }
  if (source) {
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.ImageMultilabelDataParameter.source)
}

// optional uint32 label_dim = 13 [default = 1];
inline bool ImageMultilabelDataParameter::has_label_dim() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void ImageMultilabelDataParameter::set_has_label_dim() {
  _has_bits_[0] |= 0x00000002u;
}
inline void ImageMultilabelDataParameter::clear_has_label_dim() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void ImageMultilabelDataParameter::clear_label_dim() {
  label_dim_ = 1u;
  clear_has_label_dim();
}
inline ::google::protobuf::uint32 ImageMultilabelDataParameter::label_dim() const {
  // @@protoc_insertion_point(field_get:caffe.ImageMultilabelDataParameter.label_dim)
  return label_dim_;
}
inline void ImageMultilabelDataParameter::set_label_dim(::google::protobuf::uint32 value) {
  set_has_label_dim();
  label_dim_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImageMultilabelDataParameter.label_dim)
}

// optional uint32 batch_size = 4 [default = 1];
inline bool ImageMultilabelDataParameter::has_batch_size() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void ImageMultilabelDataParameter::set_has_batch_size() {
  _has_bits_[0] |= 0x00000004u;
}
inline void ImageMultilabelDataParameter::clear_has_batch_size() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void ImageMultilabelDataParameter::clear_batch_size() {
  batch_size_ = 1u;
  clear_has_batch_size();
}
inline ::google::protobuf::uint32 ImageMultilabelDataParameter::batch_size() const {
  // @@protoc_insertion_point(field_get:caffe.ImageMultilabelDataParameter.batch_size)
  return batch_size_;
}
inline void ImageMultilabelDataParameter::set_batch_size(::google::protobuf::uint32 value) {
  set_has_batch_size();
  batch_size_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImageMultilabelDataParameter.batch_size)
}

// optional uint32 rand_skip = 7 [default = 0];
inline bool ImageMultilabelDataParameter::has_rand_skip() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void ImageMultilabelDataParameter::set_has_rand_skip() {
  _has_bits_[0] |= 0x00000008u;
}
inline void ImageMultilabelDataParameter::clear_has_rand_skip() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void ImageMultilabelDataParameter::clear_rand_skip() {
  rand_skip_ = 0u;
  clear_has_rand_skip();
}
inline ::google::protobuf::uint32 ImageMultilabelDataParameter::rand_skip() const {
  // @@protoc_insertion_point(field_get:caffe.ImageMultilabelDataParameter.rand_skip)
  return rand_skip_;
}
inline void ImageMultilabelDataParameter::set_rand_skip(::google::protobuf::uint32 value) {
  set_has_rand_skip();
  rand_skip_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImageMultilabelDataParameter.rand_skip)
}

// optional bool shuffle = 8 [default = false];
inline bool ImageMultilabelDataParameter::has_shuffle() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void ImageMultilabelDataParameter::set_has_shuffle() {
  _has_bits_[0] |= 0x00000010u;
}
inline void ImageMultilabelDataParameter::clear_has_shuffle() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void ImageMultilabelDataParameter::clear_shuffle() {
  shuffle_ = false;
  clear_has_shuffle();
}
inline bool ImageMultilabelDataParameter::shuffle() const {
  // @@protoc_insertion_point(field_get:caffe.ImageMultilabelDataParameter.shuffle)
  return shuffle_;
}
inline void ImageMultilabelDataParameter::set_shuffle(bool value) {
  set_has_shuffle();
  shuffle_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImageMultilabelDataParameter.shuffle)
}

// optional uint32 new_height = 9 [default = 0];
inline bool ImageMultilabelDataParameter::has_new_height() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void ImageMultilabelDataParameter::set_has_new_height() {
  _has_bits_[0] |= 0x00000020u;
}
inline void ImageMultilabelDataParameter::clear_has_new_height() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void ImageMultilabelDataParameter::clear_new_height() {
  new_height_ = 0u;
  clear_has_new_height();
}
inline ::google::protobuf::uint32 ImageMultilabelDataParameter::new_height() const {
  // @@protoc_insertion_point(field_get:caffe.ImageMultilabelDataParameter.new_height)
  return new_height_;
}
inline void ImageMultilabelDataParameter::set_new_height(::google::protobuf::uint32 value) {
  set_has_new_height();
  new_height_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImageMultilabelDataParameter.new_height)
}

// optional uint32 new_width = 10 [default = 0];
inline bool ImageMultilabelDataParameter::has_new_width() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void ImageMultilabelDataParameter::set_has_new_width() {
  _has_bits_[0] |= 0x00000040u;
}
inline void ImageMultilabelDataParameter::clear_has_new_width() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void ImageMultilabelDataParameter::clear_new_width() {
  new_width_ = 0u;
  clear_has_new_width();
}
inline ::google::protobuf::uint32 ImageMultilabelDataParameter::new_width() const {
  // @@protoc_insertion_point(field_get:caffe.ImageMultilabelDataParameter.new_width)
  return new_width_;
}
inline void ImageMultilabelDataParameter::set_new_width(::google::protobuf::uint32 value) {
  set_has_new_width();
  new_width_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImageMultilabelDataParameter.new_width)
}

// optional bool is_color = 11 [default = true];
inline bool ImageMultilabelDataParameter::has_is_color() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void ImageMultilabelDataParameter::set_has_is_color() {
  _has_bits_[0] |= 0x00000080u;
}
inline void ImageMultilabelDataParameter::clear_has_is_color() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void ImageMultilabelDataParameter::clear_is_color() {
  is_color_ = true;
  clear_has_is_color();
}
inline bool ImageMultilabelDataParameter::is_color() const {
  // @@protoc_insertion_point(field_get:caffe.ImageMultilabelDataParameter.is_color)
  return is_color_;
}
inline void ImageMultilabelDataParameter::set_is_color(bool value) {
  set_has_is_color();
  is_color_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImageMultilabelDataParameter.is_color)
}

// optional float scale = 2 [default = 1];
inline bool ImageMultilabelDataParameter::has_scale() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void ImageMultilabelDataParameter::set_has_scale() {
  _has_bits_[0] |= 0x00000100u;
}
inline void ImageMultilabelDataParameter::clear_has_scale() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void ImageMultilabelDataParameter::clear_scale() {
  scale_ = 1;
  clear_has_scale();
}
inline float ImageMultilabelDataParameter::scale() const {
  // @@protoc_insertion_point(field_get:caffe.ImageMultilabelDataParameter.scale)
  return scale_;
}
inline void ImageMultilabelDataParameter::set_scale(float value) {
  set_has_scale();
  scale_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImageMultilabelDataParameter.scale)
}

// optional string mean_file = 3;
inline bool ImageMultilabelDataParameter::has_mean_file() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void ImageMultilabelDataParameter::set_has_mean_file() {
  _has_bits_[0] |= 0x00000200u;
}
inline void ImageMultilabelDataParameter::clear_has_mean_file() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void ImageMultilabelDataParameter::clear_mean_file() {
  if (mean_file_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    mean_file_->clear();
  }
  clear_has_mean_file();
}
inline const ::std::string& ImageMultilabelDataParameter::mean_file() const {
  // @@protoc_insertion_point(field_get:caffe.ImageMultilabelDataParameter.mean_file)
  return *mean_file_;
}
inline void ImageMultilabelDataParameter::set_mean_file(const ::std::string& value) {
  set_has_mean_file();
  if (mean_file_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    mean_file_ = new ::std::string;
  }
  mean_file_->assign(value);
  // @@protoc_insertion_point(field_set:caffe.ImageMultilabelDataParameter.mean_file)
}
inline void ImageMultilabelDataParameter::set_mean_file(const char* value) {
  set_has_mean_file();
  if (mean_file_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    mean_file_ = new ::std::string;
  }
  mean_file_->assign(value);
  // @@protoc_insertion_point(field_set_char:caffe.ImageMultilabelDataParameter.mean_file)
}
inline void ImageMultilabelDataParameter::set_mean_file(const char* value, size_t size) {
  set_has_mean_file();
  if (mean_file_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    mean_file_ = new ::std::string;
  }
  mean_file_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:caffe.ImageMultilabelDataParameter.mean_file)
}
inline ::std::string* ImageMultilabelDataParameter::mutable_mean_file() {
  set_has_mean_file();
  if (mean_file_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    mean_file_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:caffe.ImageMultilabelDataParameter.mean_file)
  return mean_file_;
}
inline ::std::string* ImageMultilabelDataParameter::release_mean_file() {
  clear_has_mean_file();
  if (mean_file_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
...
inline void ImageMultilabelDataParameter::set_allocated_mean_file(::std::string* mean_file) {
  if (mean_file_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete mean_file_;
  }
  if (mean_file) {
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.ImageMultilabelDataParameter.mean_file)
}

// optional uint32 crop_size = 5 [default = 0];
inline bool ImageMultilabelDataParameter::has_crop_size() const {
  return (_has_bits_[0] & 0x00000400u) != 0;
}
inline void ImageMultilabelDataParameter::set_has_crop_size() {
  _has_bits_[0] |= 0x00000400u;
}
inline void ImageMultilabelDataParameter::clear_has_crop_size() {
  _has_bits_[0] &= ~0x00000400u;
}
inline void ImageMultilabelDataParameter::clear_crop_size() {
  crop_size_ = 0u;
  clear_has_crop_size();
}
inline ::google::protobuf::uint32 ImageMultilabelDataParameter::crop_size() const {
  // @@protoc_insertion_point(field_get:caffe.ImageMultilabelDataParameter.crop_size)
  return crop_size_;
}
inline void ImageMultilabelDataParameter::set_crop_size(::google::protobuf::uint32 value) {
  set_has_crop_size();
  crop_size_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImageMultilabelDataParameter.crop_size)
}

// optional bool mirror = 6 [default = false];
inline bool ImageMultilabelDataParameter::has_mirror() const {
  return (_has_bits_[0] & 0x00000800u) != 0;
}
inline void ImageMultilabelDataParameter::set_has_mirror() {
  _has_bits_[0] |= 0x00000800u;
}
inline void ImageMultilabelDataParameter::clear_has_mirror() {
  _has_bits_[0] &= ~0x00000800u;
}
inline void ImageMultilabelDataParameter::clear_mirror() {
  mirror_ = false;
  clear_has_mirror();
}
inline bool ImageMultilabelDataParameter::mirror() const {
  // @@protoc_insertion_point(field_get:caffe.ImageMultilabelDataParameter.mirror)
  return mirror_;
}
inline void ImageMultilabelDataParameter::set_mirror(bool value) {
  set_has_mirror();
  mirror_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImageMultilabelDataParameter.mirror)
}

// optional string root_folder = 12 [default = ""];
inline bool ImageMultilabelDataParameter::has_root_folder() const {
  return (_has_bits_[0] & 0x00001000u) != 0;
}
inline void ImageMultilabelDataParameter::set_has_root_folder() {
  _has_bits_[0] |= 0x00001000u;
}
inline void ImageMultilabelDataParameter::clear_has_root_folder() {
  _has_bits_[0] &= ~0x00001000u;
}
inline void ImageMultilabelDataParameter::clear_root_folder() {
  if (root_folder_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    root_folder_->clear();
  }
  clear_has_root_folder();
}
inline const ::std::string& ImageMultilabelDataParameter::root_folder() const {
  // @@protoc_insertion_point(field_get:caffe.ImageMultilabelDataParameter.root_folder)
  return *root_folder_;
}
inline void ImageMultilabelDataParameter::set_root_folder(const ::std::string& value) {
  set_has_root_folder();
  if (root_folder_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    root_folder_ = new ::std::string;
  }
  root_folder_->assign(value);
  // @@protoc_insertion_point(field_set:caffe.ImageMultilabelDataParameter.root_folder)
}
inline void ImageMultilabelDataParameter::set_root_folder(const char* value) {
  set_has_root_folder();
  if (root_folder_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    root_folder_ = new ::std::string;
  }
  root_folder_->assign(value);
  // @@protoc_insertion_point(field_set_char:caffe.ImageMultilabelDataParameter.root_folder)
}
inline void ImageMultilabelDataParameter::set_root_folder(const char* value, size_t size) {
  set_has_root_folder();
  if (root_folder_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    root_folder_ = new ::std::string;
  }
  root_folder_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:caffe.ImageMultilabelDataParameter.root_folder)
}
inline ::std::string* ImageMultilabelDataParameter::mutable_root_folder() {
  set_has_root_folder();
  if (root_folder_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    root_folder_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:caffe.ImageMultilabelDataParameter.root_folder)
  return root_folder_;
}
inline ::std::string* ImageMultilabelDataParameter::release_root_folder() {
  clear_has_root_folder();
  if (root_folder_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
...
inline void ImageMultilabelDataParameter::set_allocated_root_folder(::std::string* root_folder) {
  if (root_folder_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete root_folder_;
  }
  if (root_folder) {
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.ImageMultilabelDataParameter.root_folder)
}
...
// optional uint32 depth = 1 [default = 3];
inline bool NeuralDecisionForestParameter::has_depth() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void NeuralDecisionForestParameter::set_has_depth() {
  _has_bits_[0] |= 0x00000001u;
}
inline void NeuralDecisionForestParameter::clear_has_depth() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void NeuralDecisionForestParameter::clear_depth() {
  depth_ = 3u;
  clear_has_depth();
}
inline ::google::protobuf::uint32 NeuralDecisionForestParameter::depth() const {
  // @@protoc_insertion_point(field_get:caffe.NeuralDecisionForestParameter.depth)
  return depth_;
}
inline void NeuralDecisionForestParameter::set_depth(::google::protobuf::uint32 value) {
  set_has_depth();
  depth_ = value;
  // @@protoc_insertion_point(field_set:caffe.NeuralDecisionForestParameter.depth)
}

// optional uint32 num_trees = 2 [default = 1];
inline bool NeuralDecisionForestParameter::has_num_trees() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void NeuralDecisionForestParameter::set_has_num_trees() {
  _has_bits_[0] |= 0x00000002u;
}
inline void NeuralDecisionForestParameter::clear_has_num_trees() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void NeuralDecisionForestParameter::clear_num_trees() {
  num_trees_ = 1u;
  clear_has_num_trees();
}
inline ::google::protobuf::uint32 NeuralDecisionForestParameter::num_trees() const {
  // @@protoc_insertion_point(field_get:caffe.NeuralDecisionForestParameter.num_trees)
  return num_trees_;
}
inline void NeuralDecisionForestParameter::set_num_trees(::google::protobuf::uint32 value) {
  set_has_num_trees();
  num_trees_ = value;
  // @@protoc_insertion_point(field_set:caffe.NeuralDecisionForestParameter.num_trees)
}

// optional uint32 num_classes = 3 [default = 2];
inline bool NeuralDecisionForestParameter::has_num_classes() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void NeuralDecisionForestParameter::set_has_num_classes() {
  _has_bits_[0] |= 0x00000004u;
}
inline void NeuralDecisionForestParameter::clear_has_num_classes() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void NeuralDecisionForestParameter::clear_num_classes() {
  num_classes_ = 2u;
  clear_has_num_classes();
}
inline ::google::protobuf::uint32 NeuralDecisionForestParameter::num_classes() const {
  // @@protoc_insertion_point(field_get:caffe.NeuralDecisionForestParameter.num_classes)
  return num_classes_;
}
inline void NeuralDecisionForestParameter::set_num_classes(::google::protobuf::uint32 value) {
  set_has_num_classes();
  num_classes_ = value;
  // @@protoc_insertion_point(field_set:caffe.NeuralDecisionForestParameter.num_classes)
}

// optional uint32 iter_times_class_label_distr = 4 [default = 20];
inline bool NeuralDecisionForestParameter::has_iter_times_class_label_distr() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void NeuralDecisionForestParameter::set_has_iter_times_class_label_distr() {
  _has_bits_[0] |= 0x00000008u;
}
inline void NeuralDecisionForestParameter::clear_has_iter_times_class_label_distr() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void NeuralDecisionForestParameter::clear_iter_times_class_label_distr() {
  iter_times_class_label_distr_ = 20u;
  clear_has_iter_times_class_label_distr();
}
inline ::google::protobuf::uint32 NeuralDecisionForestParameter::iter_times_class_label_distr() const {
  // @@protoc_insertion_point(field_get:caffe.NeuralDecisionForestParameter.iter_times_class_label_distr)
  return iter_times_class_label_distr_;
}
inline void NeuralDecisionForestParameter::set_iter_times_class_label_distr(::google::protobuf::uint32 value) {
  set_has_iter_times_class_label_distr();
  iter_times_class_label_distr_ = value;
  // @@protoc_insertion_point(field_set:caffe.NeuralDecisionForestParameter.iter_times_class_label_distr)
}

// optional uint32 iter_times_in_epoch = 7 [default = 20];
inline bool NeuralDecisionForestParameter::has_iter_times_in_epoch() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void NeuralDecisionForestParameter::set_has_iter_times_in_epoch() {
  _has_bits_[0] |= 0x00000010u;
}
inline void NeuralDecisionForestParameter::clear_has_iter_times_in_epoch() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void NeuralDecisionForestParameter::clear_iter_times_in_epoch() {
  iter_times_in_epoch_ = 20u;
  clear_has_iter_times_in_epoch();
}
inline ::google::protobuf::uint32 NeuralDecisionForestParameter::iter_times_in_epoch() const {
  // @@protoc_insertion_point(field_get:caffe.NeuralDecisionForestParameter.iter_times_in_epoch)
  return iter_times_in_epoch_;
}
inline void NeuralDecisionForestParameter::set_iter_times_in_epoch(::google::protobuf::uint32 value) {
  set_has_iter_times_in_epoch();
  iter_times_in_epoch_ = value;
  // @@protoc_insertion_point(field_set:caffe.NeuralDecisionForestParameter.iter_times_in_epoch)
}

// optional string record_filename = 5 [default = "Forest.Record"];
inline bool NeuralDecisionForestParameter::has_record_filename() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void NeuralDecisionForestParameter::set_has_record_filename() {
  _has_bits_[0] |= 0x00000020u;
}
inline void NeuralDecisionForestParameter::clear_has_record_filename() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void NeuralDecisionForestParameter::clear_record_filename() {
  if (record_filename_ != _default_record_filename_) {
    record_filename_->assign(*_default_record_filename_);
  }
  clear_has_record_filename();
}
inline const ::std::string& NeuralDecisionForestParameter::record_filename() const {
  // @@protoc_insertion_point(field_get:caffe.NeuralDecisionForestParameter.record_filename)
  return *record_filename_;
}
inline void NeuralDecisionForestParameter::set_record_filename(const ::std::string& value) {
  set_has_record_filename();
  if (record_filename_ == _default_record_filename_) {
    record_filename_ = new ::std::string;
  }
  record_filename_->assign(value);
  // @@protoc_insertion_point(field_set:caffe.NeuralDecisionForestParameter.record_filename)
}
inline void NeuralDecisionForestParameter::set_record_filename(const char* value) {
  set_has_record_filename();
  if (record_filename_ == _default_record_filename_) {
    record_filename_ = new ::std::string;
  }
  record_filename_->assign(value);
  // @@protoc_insertion_point(field_set_char:caffe.NeuralDecisionForestParameter.record_filename)
}
inline void NeuralDecisionForestParameter::set_record_filename(const char* value, size_t size) {
  set_has_record_filename();
  if (record_filename_ == _default_record_filename_) {
    record_filename_ = new ::std::string;
  }
  record_filename_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:caffe.NeuralDecisionForestParameter.record_filename)
}
inline ::std::string* NeuralDecisionForestParameter::mutable_record_filename() {
  set_has_record_filename();
  if (record_filename_ == _default_record_filename_) {
    record_filename_ = new ::std::string(*_default_record_filename_);
  }
  // @@protoc_insertion_point(field_mutable:caffe.NeuralDecisionForestParameter.record_filename)
  return record_filename_;
}
inline ::std::string* NeuralDecisionForestParameter::release_record_filename() {
  clear_has_record_filename();
  if (record_filename_ == _default_record_filename_) {
    return NULL;
  } else {
    ::std::string* temp = record_filename_;
    record_filename_ = const_cast< ::std::string*>(_default_record_filename_);
    return temp;
  }
}
inline void NeuralDecisionForestParameter::set_allocated_record_filename(::std::string* record_filename) {
  if (record_filename_ != _default_record_filename_) {
    delete record_filename_;
  }
  if (record_filename) {
    set_has_record_filename();
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.NeuralDecisionForestParameter.record_filename)
}

// optional uint32 axis = 6 [default = 1];
inline bool NeuralDecisionForestParameter::has_axis() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void NeuralDecisionForestParameter::set_has_axis() {
  _has_bits_[0] |= 0x00000040u;
}
inline void NeuralDecisionForestParameter::clear_has_axis() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void NeuralDecisionForestParameter::clear_axis() {
  axis_ = 1u;
  clear_has_axis();
}
inline ::google::protobuf::uint32 NeuralDecisionForestParameter::axis() const {
  // @@protoc_insertion_point(field_get:caffe.NeuralDecisionForestParameter.axis)
  return axis_;
}
inline void NeuralDecisionForestParameter::set_axis(::google::protobuf::uint32 value) {
  set_has_axis();
  axis_ = value;
  // @@protoc_insertion_point(field_set:caffe.NeuralDecisionForestParameter.axis)
}

// optional bool debug_gpu = 8 [default = false];
inline bool NeuralDecisionForestParameter::has_debug_gpu() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void NeuralDecisionForestParameter::set_has_debug_gpu() {
  _has_bits_[0] |= 0x00000080u;
}
inline void NeuralDecisionForestParameter::clear_has_debug_gpu() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void NeuralDecisionForestParameter::clear_debug_gpu() {
  debug_gpu_ = false;
  clear_has_debug_gpu();
}
inline bool NeuralDecisionForestParameter::debug_gpu() const {
  // @@protoc_insertion_point(field_get:caffe.NeuralDecisionForestParameter.debug_gpu)
  return debug_gpu_;
}
inline void NeuralDecisionForestParameter::set_debug_gpu(bool value) {
  set_has_debug_gpu();
  debug_gpu_ = value;
  // @@protoc_insertion_point(field_set:caffe.NeuralDecisionForestParameter.debug_gpu)
}

// optional bool use_gpu = 9 [default = true];
inline bool NeuralDecisionForestParameter::has_use_gpu() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void NeuralDecisionForestParameter::set_has_use_gpu() {
  _has_bits_[0] |= 0x00000100u;
}
inline void NeuralDecisionForestParameter::clear_has_use_gpu() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void NeuralDecisionForestParameter::clear_use_gpu() {
  use_gpu_ = true;
  clear_has_use_gpu();
}
inline bool NeuralDecisionForestParameter::use_gpu() const {
  // @@protoc_insertion_point(field_get:caffe.NeuralDecisionForestParameter.use_gpu)
  return use_gpu_;
}
inline void NeuralDecisionForestParameter::set_use_gpu(bool value) {
  set_has_use_gpu();
  use_gpu_ = value;
  // @@protoc_insertion_point(field_set:caffe.NeuralDecisionForestParameter.use_gpu)
}

// optional uint32 all_data_vec_length = 10 [default = 5];
inline bool NeuralDecisionForestParameter::has_all_data_vec_length() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void NeuralDecisionForestParameter::set_has_all_data_vec_length() {
  _has_bits_[0] |= 0x00000200u;
}
inline void NeuralDecisionForestParameter::clear_has_all_data_vec_length() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void NeuralDecisionForestParameter::clear_all_data_vec_length() {
  all_data_vec_length_ = 5u;
  clear_has_all_data_vec_length();
}
inline ::google::protobuf::uint32 NeuralDecisionForestParameter::all_data_vec_length() const {
  // @@protoc_insertion_point(field_get:caffe.NeuralDecisionForestParameter.all_data_vec_length)
  return all_data_vec_length_;
}
inline void NeuralDecisionForestParameter::set_all_data_vec_length(::google::protobuf::uint32 value) {
  set_has_all_data_vec_length();
  all_data_vec_length_ = value;
  // @@protoc_insertion_point(field_set:caffe.NeuralDecisionForestParameter.all_data_vec_length)
}

// optional bool drop_out = 11 [default = false];
inline bool NeuralDecisionForestParameter::has_drop_out() const {
  return (_has_bits_[0] & 0x00000400u) != 0;
}
inline void NeuralDecisionForestParameter::set_has_drop_out() {
  _has_bits_[0] |= 0x00000400u;
}
inline void NeuralDecisionForestParameter::clear_has_drop_out() {
  _has_bits_[0] &= ~0x00000400u;
}
inline void NeuralDecisionForestParameter::clear_drop_out() {
  drop_out_ = false;
  clear_has_drop_out();
}
inline bool NeuralDecisionForestParameter::drop_out() const {
  // @@protoc_insertion_point(field_get:caffe.NeuralDecisionForestParameter.drop_out)
  return drop_out_;
}
inline void NeuralDecisionForestParameter::set_drop_out(bool value) {
  set_has_drop_out();
  drop_out_ = value;
  // @@protoc_insertion_point(field_set:caffe.NeuralDecisionForestParameter.drop_out)
}

// optional string init_filename = 12 [default = "Leafnode.Init"];
inline bool NeuralDecisionForestParameter::has_init_filename() const {
  return (_has_bits_[0] & 0x00000800u) != 0;
}
inline void NeuralDecisionForestParameter::set_has_init_filename() {
  _has_bits_[0] |= 0x00000800u;
}
inline void NeuralDecisionForestParameter::clear_has_init_filename() {
  _has_bits_[0] &= ~0x00000800u;
}
inline void NeuralDecisionForestParameter::clear_init_filename() {
  if (init_filename_ != _default_init_filename_) {
    init_filename_->assign(*_default_init_filename_);
  }
  clear_has_init_filename();
}
inline const ::std::string& NeuralDecisionForestParameter::init_filename() const {
  // @@protoc_insertion_point(field_get:caffe.NeuralDecisionForestParameter.init_filename)
  return *init_filename_;
}
inline void NeuralDecisionForestParameter::set_init_filename(const ::std::string& value) {
  set_has_init_filename();
  if (init_filename_ == _default_init_filename_) {
    init_filename_ = new ::std::string;
  }
  init_filename_->assign(value);
  // @@protoc_insertion_point(field_set:caffe.NeuralDecisionForestParameter.init_filename)
}
inline void NeuralDecisionForestParameter::set_init_filename(const char* value) {
  set_has_init_filename();
  if (init_filename_ == _default_init_filename_) {
    init_filename_ = new ::std::string;
  }
  init_filename_->assign(value);
  // @@protoc_insertion_point(field_set_char:caffe.NeuralDecisionForestParameter.init_filename)
}
inline void NeuralDecisionForestParameter::set_init_filename(const char* value, size_t size) {
  set_has_init_filename();
  if (init_filename_ == _default_init_filename_) {
    init_filename_ = new ::std::string;
  }
  init_filename_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:caffe.NeuralDecisionForestParameter.init_filename)
}
inline ::std::string* NeuralDecisionForestParameter::mutable_init_filename() {
  set_has_init_filename();
  if (init_filename_ == _default_init_filename_) {
    init_filename_ = new ::std::string(*_default_init_filename_);
  }
  // @@protoc_insertion_point(field_mutable:caffe.NeuralDecisionForestParameter.init_filename)
  return init_filename_;
}
inline ::std::string* NeuralDecisionForestParameter::release_init_filename() {
  clear_has_init_filename();
  if (init_filename_ == _default_init_filename_) {
    return NULL;
  } else {
    ::std::string* temp = init_filename_;
    init_filename_ = const_cast< ::std::string*>(_default_init_filename_);
    return temp;
  }
}
inline void NeuralDecisionForestParameter::set_allocated_init_filename(::std::string* init_filename) {
  if (init_filename_ != _default_init_filename_) {
    delete init_filename_;
  }
  if (init_filename) {
    set_has_init_filename();
    init_filename_ = init_filename;
  } else {
    clear_has_init_filename();
    init_filename_ = const_cast< ::std::string*>(_default_init_filename_);
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.NeuralDecisionForestParameter.init_filename)
}

// optional float scale = 13 [default = 100];
inline bool NeuralDecisionForestParameter::has_scale() const {
  return (_has_bits_[0] & 0x00001000u) != 0;
}
inline void NeuralDecisionForestParameter::set_has_scale() {
  _has_bits_[0] |= 0x00001000u;
}
inline void NeuralDecisionForestParameter::clear_has_scale() {
  _has_bits_[0] &= ~0x00001000u;
}
inline void NeuralDecisionForestParameter::clear_scale() {
  scale_ = 100;
  clear_has_scale();
}
inline float NeuralDecisionForestParameter::scale() const {
  // @@protoc_insertion_point(field_get:caffe.NeuralDecisionForestParameter.scale)
  return scale_;
}
inline void NeuralDecisionForestParameter::set_scale(float value) {
  set_has_scale();
  scale_ = value;
  // @@protoc_insertion_point(field_set:caffe.NeuralDecisionForestParameter.scale)
}
...
// optional .caffe.LDLMetricParameter.LDLMetricType metric_type = 1 [default = KLD];
inline bool LDLMetricParameter::has_metric_type() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void LDLMetricParameter::set_has_metric_type() {
  _has_bits_[0] |= 0x00000001u;
}
inline void LDLMetricParameter::clear_has_metric_type() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void LDLMetricParameter::clear_metric_type() {
  metric_type_ = 1;
  clear_has_metric_type();
}
inline ::caffe::LDLMetricParameter_LDLMetricType LDLMetricParameter::metric_type() const {
  // @@protoc_insertion_point(field_get:caffe.LDLMetricParameter.metric_type)
  return static_cast< ::caffe::LDLMetricParameter_LDLMetricType >(metric_type_);
}
inline void LDLMetricParameter::set_metric_type(::caffe::LDLMetricParameter_LDLMetricType value) {
  assert(::caffe::LDLMetricParameter_LDLMetricType_IsValid(value));
  set_has_metric_type();
  metric_type_ = value;
  // @@protoc_insertion_point(field_set:caffe.LDLMetricParameter.metric_type)
}
...
// optional int32 lll = 1 [default = 5];
inline bool CSParameter::has_lll() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void CSParameter::set_has_lll() {
  _has_bits_[0] |= 0x00000001u;
}
inline void CSParameter::clear_has_lll() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void CSParameter::clear_lll() {
  lll_ = 5;
  clear_has_lll();
}
inline ::google::protobuf::int32 CSParameter::lll() const {
  // @@protoc_insertion_point(field_get:caffe.CSParameter.lll)
  return lll_;
}
inline void CSParameter::set_lll(::google::protobuf::int32 value) {
  set_has_lll();
  lll_ = value;
  // @@protoc_insertion_point(field_set:caffe.CSParameter.lll)
}
...
// optional .caffe.ImageMultilabelDataParameter image_multilabel_data_param = 47;
inline bool V1LayerParameter::has_image_multilabel_data_param() const {
  return (_has_bits_[0] & 0x04000000u) != 0;
}
inline void V1LayerParameter::set_has_image_multilabel_data_param() {
  _has_bits_[0] |= 0x04000000u;
}
inline void V1LayerParameter::clear_has_image_multilabel_data_param() {
  _has_bits_[0] &= ~0x04000000u;
}
inline void V1LayerParameter::clear_image_multilabel_data_param() {
  if (image_multilabel_data_param_ != NULL) image_multilabel_data_param_->::caffe::ImageMultilabelDataParameter::Clear();
  clear_has_image_multilabel_data_param();
}
inline const ::caffe::ImageMultilabelDataParameter& V1LayerParameter::image_multilabel_data_param() const {
  // @@protoc_insertion_point(field_get:caffe.V1LayerParameter.image_multilabel_data_param)
  return image_multilabel_data_param_ != NULL ? *image_multilabel_data_param_ : *default_instance_->image_multilabel_data_param_;
}
inline ::caffe::ImageMultilabelDataParameter* V1LayerParameter::mutable_image_multilabel_data_param() {
  set_has_image_multilabel_data_param();
  if (image_multilabel_data_param_ == NULL) image_multilabel_data_param_ = new ::caffe::ImageMultilabelDataParameter;
  // @@protoc_insertion_point(field_mutable:caffe.V1LayerParameter.image_multilabel_data_param)
  return image_multilabel_data_param_;
}
inline ::caffe::ImageMultilabelDataParameter* V1LayerParameter::release_image_multilabel_data_param() {
  clear_has_image_multilabel_data_param();
  ::caffe::ImageMultilabelDataParameter* temp = image_multilabel_data_param_;
  image_multilabel_data_param_ = NULL;
  return temp;
}
inline void V1LayerParameter::set_allocated_image_multilabel_data_param(::caffe::ImageMultilabelDataParameter* image_multilabel_data_param) {
  delete image_multilabel_data_param_;
  image_multilabel_data_param_ = image_multilabel_data_param;
  if (image_multilabel_data_param) {
    set_has_image_multilabel_data_param();
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.V1LayerParameter.image_multilabel_data_param)
}
...
template <> struct is_proto_enum< ::caffe::LDLMetricParameter_LDLMetricType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::caffe::LDLMetricParameter_LDLMetricType>() {
  return ::caffe::LDLMetricParameter_LDLMetricType_descriptor();
}
